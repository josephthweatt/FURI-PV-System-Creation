...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.example.family.furi/databases/";
    private static String DB_NAME = "PVModels.db";
    ...
    public Cursor query(String table) {
        ...
        return mDataBase.rawQuery("select * from " + table, null);
    }
}